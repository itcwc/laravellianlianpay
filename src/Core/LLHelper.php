...
class LLHelper
{
    public static function encryptPayLoad($plaintext, $public_key): string
    {
    ...
    private static function lianlianpayEncrypt($req, $public_key, $hmack_key, $version, $aes_key, $nonce): string
    {
    ...
    private static function genLetterDigitRandom($size): string
    {
    ...
    private static function aesEncrypt($data, $key, $nonce): string
    {
    ...
    private static function rsaEncrypt($data, $public_key): string
    {
